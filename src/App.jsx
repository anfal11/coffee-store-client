...
<div className="flex flex-col md:flex-row justify-around gap-10">
       ...
       <img src="https://i.ibb.co/6t06vJb/1.png" alt="" />
        <h1 className="text-[#331A15] font-Rancho text-3xl pt-2"> Awesome Aroma </h1>
        <p className="text-[#1B1A1A] font-Raleway pt-2 text-center md:text-start">You will definitely be a fan of the design & aroma of your coffee</p>
       </div>
       <div className="grid grid-cols-1 place-items-center md:place-items-start">
       <img src="https://i.ibb.co/QmvFZNp/2.png" alt="" />
        <h1 className="text-[#331A15] font-Rancho text-3xl pt-2"> High Quality </h1>
        <p className="text-[#1B1A1A] font-Raleway pt-2 text-center md:text-start">We served the coffee to you maintaining the best quality</p>
       </div>
        <div className="grid grid-cols-1 place-items-center md:place-items-start">
        <img src="https://i.ibb.co/x5PrzTb/3.png" alt="" />
        <h1 className="text-[#331A15] font-Rancho text-3xl pt-2"> Pure Grades </h1>
        <p className="text-[#1B1A1A] font-Raleway pt-2 text-center md:text-start">The coffee is made of the green coffee beans which you will love</p>
        </div>
        <div className="grid grid-cols-1 place-items-center md:place-items-start">
        <img src="https://i.ibb.co/FgN2hbX/4.png" alt="" />
        <h1 className="text-[#331A15] font-Rancho text-3xl pt-2"> Proper Roasting </h1>
        <p className="text-[#1B1A1A] font-Raleway pt-2 text-center md:text-start">Your coffee is brewed by first roasting the green coffee beans</p>
        </div>
        </div>
</div>
      </div>
