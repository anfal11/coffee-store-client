    ...
    <div className="bg-gray-100 p-5 flex rounded-2xl shadow-lg max-w-3xl">
      <div className="md:w-1/2 px-5">
        ...
        <div className="text-sm flex justify-between items-center mt-3">
          ...
          <Link to='/signup'>
          <button className="py-2 px-5 ml-3 bg-white border rounded-xl hover:scale-110 duration-300 border-blue-400 ">SignUp</button>
          </Link>
        </div>
      </div>

      <div className="w-1/2 md:block hidden ">
        <img src="https://i.imgur.com/xO5xvOh.jpg" className="rounded-2xl mt-20" alt="page img"/>
      </div>
