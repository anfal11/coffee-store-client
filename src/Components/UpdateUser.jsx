...
const UpdateUser = () => {
    ...
    const handleUpdate = (e) => {
        ...
        fetch(`https://coffee-store-server-1xx3ez9au-anfal11.vercel.app/users/${_id}`, {
            method: 'PUT',
            headers: { 
    ...
    return (
      ...
      <h1 className="font-Rancho text-6xl text-center">Update Existing User</h1>
        ...
        <div className="flex justify-center">
                <input type="submit" value='Update User Details' className="btn bg-[#D2B48C] font-Rancho text-2xl mt-6 md:w-[300px] lg:w-[740px] xl:w-[1000px] border-black" />
             </div>
      </div>
            </form>
        </div>
